...
def test_add_duplicate_skill_rejected(client, auth_headers):
    payload = {"skill_name": "Linux", "proficiency": "Beginner", "years_of_experience": 1}
...
def test_list_skills(client, auth_headers):
    client.post("/api/skills", json={"skill_name": "Git", "proficiency": "Advanced", "years_of_experience": 2},
                headers=auth_headers)
...
def test_delete_skill(client, auth_headers):
    add_resp = client.post("/api/skills", json={"skill_name": "AWS", "proficiency": "Beginner",
